...
# HTML components (unchanged, omitted for brevity)
...
def check_for_updates():
    ...
    repo_url = "https://github.com/ankush-deshpande17/automation-scripts"
    repo_raw_url = "https://raw.githubusercontent.com/ankush-deshpande17/automation-scripts/main/viya4_environment_troubleshooting_v1.py"
    ...
    try:
        ...
        version_match = re.search(r"SCRIPT_VERSION\s*=\s*['\"]v(\d+\.\d+\.\d+)['\"]", latest_script)
        if not version_match:
            print("Could not determine latest version from remote script.")
            return
